...
{% tab title="Perl" %}
```text
quest::crosszonecastspellbycharid(character_id, spell_id, min_status, max_status);
quest::crosszonecastspellbygroupid(group_id, spell_id, min_status, max_status);
quest::crosszonecastspellbyraidid(raid_id, spell_id, min_status, max_status);
quest::crosszonecastspellbyguildid(guild_id, spell_id, min_status, max_status);
quest::crosszonedisabletaskbycharid(character_id, task_id, min_status, max_status);
quest::crosszonedisabletaskbygroupid(group_id, task_id, min_status, max_status);
quest::crosszonedisabletaskbyraidid(raid_id, task_id, min_status, max_status);
quest::crosszonedisabletaskbyguildid(guild_id, task_id, min_status, max_status);
quest::crosszoneenabletaskbycharid(character_id, task_id, min_status, max_status);
quest::crosszoneenabletaskbygroupid(group_id, task_id, min_status, max_status);
quest::crosszoneenabletaskbyraidid(raid_id, task_id, min_status, max_status);
quest::crosszoneenabletaskbyguildid(guild_id, task_id, min_status, max_status);
quest::crosszonefailtaskbycharid(character_id, task_id, min_status, max_status);
quest::crosszonefailtaskbygroupid(group_id, task_id, min_status, max_status);
quest::crosszonefailtaskbyraidid(raid_id, task_id, min_status, max_status);
quest::crosszonefailtaskbyguildid(guild_id, task_id, min_status, max_status);
quest::crosszonemoveinstancebycharid(character_id, instance_id, min_status, max_status);
quest::crosszonemoveinstancebygroupid(group_id, instance_id, min_status, max_status);
quest::crosszonemoveinstancebyraidid(raid_id, instance_id, min_status, max_status);
quest::crosszonemoveinstancebyguildid(guild_id, instance_id, min_status, max_status);
quest::crosszoneremovespellbycharid(character_id, spell_id, min_status, max_status);
quest::crosszoneremovespellbygroupid(group_id, spell_id, min_status, max_status);
quest::crosszoneremovespellbyraidid(raid_id, spell_id, min_status, max_status);
quest::crosszoneremovespellbyguildid(guild_id, spell_id, min_status, max_status);
quest::crosszoneresetactivitybycharid(character_id, task_id, activity_id, min_status, max_status);
quest::crosszoneresetactivitybygroupid(group_id, task_id, activity_id, min_status, max_status);
quest::crosszoneresetactivitybyraidid(raid_id, task_id, activity_id, min_status, max_status);
quest::crosszoneresetactivitybyguildid(guild_id, task_id, activity_id, min_status, max_status);
quest::crosszoneupdateactivitybycharid(character_id, task_id, activity_id, activity_count, min_status, max_status);
quest::crosszoneupdateactivitybygroupid(group_id, task_id, activity_id, activity_count, min_status, max_status);
quest::crosszoneupdateactivitybyraidid(raid_id, task_id, activity_id, activity_count, min_status, max_status);
quest::crosszoneupdateactivitybyguildid(guild_id, task_id, activity_id, activity_count, min_status, max_status);
...
{% tab title="Lua" %}
```lua
eq.cross_zone_cast_spell_by_char_id(character_id, spell_id, min_status, max_status);
eq.cross_zone_cast_spell_by_group_id(group_id, spell_id, min_status, max_status);
eq.cross_zone_cast_spell_by_raid_id(raid_id, spell_id, min_status, max_status);
eq.cross_zone_cast_spell_by_guild_id(guild_id, spell_id, min_status, max_status);
eq.cross_zone_disable_task_by_char_id(character_id, task_id, min_status, max_status);
eq.cross_zone_disable_task_by_group_id(group_id, task_id, min_status, max_status);
eq.cross_zone_disable_task_by_raid_id(raid_id, task_id, min_status, max_status);
eq.cross_zone_disable_task_by_guild_id(guild_id, task_id, min_status, max_status);
eq.cross_zone_enable_task_by_char_id(character_id, task_id, min_status, max_status);
eq.cross_zone_enable_task_by_group_id(group_id, task_id, min_status, max_status);
eq.cross_zone_enable_task_by_raid_id(raid_id, task_id, min_status, max_status);
eq.cross_zone_enable_task_by_guild_id(guild_id, task_id, min_status, max_status);
eq.cross_zone_fail_task_by_char_id(character_id, task_id, min_status, max_status);
eq.cross_zone_fail_task_by_group_id(group_id, task_id, min_status, max_status);
eq.cross_zone_fail_task_by_raid_id(raid_id, task_id, min_status, max_status);
eq.cross_zone_fail_task_by_guild_id(guild_id, task_id, min_status, max_status);
eq.cross_zone_move_instance_by_char_id(character_id, instance_id, min_status, max_status);
eq.cross_zone_move_instance_by_group_id(group_id, instance_id, min_status, max_status);
eq.cross_zone_move_instance_by_raid_id(raid_id, instance_id, min_status, max_status);
eq.cross_zone_move_instance_by_guild_id(guild_id, instance_id, min_status, max_status);
eq.cross_zone_remove_spell_by_char_id(character_id, spell_id, min_status, max_status);
eq.cross_zone_remove_spell_by_group_id(group_id, spell_id, min_status, max_status);
eq.cross_zone_remove_spell_by_raid_id(raid_id, spell_id, min_status, max_status);
eq.cross_zone_remove_spell_by_guild_id(guild_id, spell_id, min_status, max_status);
eq.cross_zone_reset_activity_by_char_id(character_id, task_id, activity_id, min_status, max_status);
eq.cross_zone_reset_activity_by_group_id(group_id, task_id, activity_id, min_status, max_status);
eq.cross_zone_reset_activity_by_raid_id(raid_id, task_id, activity_id, min_status, max_status);
eq.cross_zone_reset_activity_by_guild_id(guild_id, task_id, activity_id, min_status, max_status);
eq.cross_zone_update_activity_by_char_id(character_id, task_id, activity_id, activity_count, min_status, max_status);
eq.cross_zone_update_activity_by_group_id(group_id, task_id, activity_id, activity_count, min_status, max_status);
eq.cross_zone_update_activity_by_raid_id(raid_id, task_id, activity_id, activity_count, min_status, max_status);
eq.cross_zone_update_activity_by_guild_id(guild_id, task_id, activity_id, activity_count, min_status, max_status);
